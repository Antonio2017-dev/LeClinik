...
public class SortedABPriQ<T> implements QueueInterface<T>  

{
	protected final int DEFCAP = 100; // default capacity
	protected T[] elements;           // array to hold priority queues elements
	...
	// priority queue and returns it.
	{
		if (!isEmpty())
		{
			...
			throw new UnderflowExcep("dequeue attempted on an empty priority queue.");
	} 
